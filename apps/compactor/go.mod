module github.com/Netcracker/qubership-profiler-backend/apps/compactor
...
require (
	github.com/Netcracker/qubership-profiler-backend v0.0.0-00010101000000-000000000000
